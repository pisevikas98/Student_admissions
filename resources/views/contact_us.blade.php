...
@endif
  ...
  <form action="{{ url('examinationsave') }}" method="post">
    {{csrf_field()}}
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="" placeholder="Enter Number" name="mobile">
    </div>
    <div class="form-group">
      <label for="mobile">Message:</label>
      <textarea class="form-control" placeholder="Enter Message" name="msg"></textarea>
    </div>
